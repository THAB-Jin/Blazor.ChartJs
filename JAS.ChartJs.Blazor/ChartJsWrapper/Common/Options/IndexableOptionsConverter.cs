...
{
    internal class IndexableOptionsConverter : JsonConverter
    {
        ...
        public override bool CanConvert(Type objectType)
        {
            ...
            return objectType.GetGenericTypeDefinition() == typeof(IndexableOptions<>);
        }
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            var prop = value.GetType().GetProperty(IndexableOptions<object>.PropertyName, BindingFlags.Instance | BindingFlags.NonPublic);
